...
This project is mainly build for tracking a user's `Codeforces` and `Leetcode` calendar(Streak) in a single profile, 
...
`Note - Please enter valid Codeforces and LeetCode Handles , otherwise it wont work`
